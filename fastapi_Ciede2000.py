    ...
    def visualize_result(results, img_path):
        ...
        for result in results:
            ...
            for box in boxes:
                ...
                cv2.putText(img, class_name, (text_x, text_y), font, font_scale, (0, 238, 238), font_thickness,
                            cv2.LINE_AA)
...
async def process_image(file: UploadFile = File(...)):
    ...
    img_base64 = base64.b64encode(img_visualized).decode('utf-8')

    # Xóa hình ảnh tạm thời sau khi đã xử lý
    os.remove(temp_image_path)

    return {"urine_colors": result, "visualized_image_base64": img_base64}
